...
def generate_fake_logs(output_file: str, num_recon: int = 100, num_dropper: int = 100, num_human: int = 100) -> None:
    """Generate synthetic Cowrie events for three attacker behavior classes."""
    ...
    def generate_session(num_sessions: int, pools: list[list[str]]) -> None:
        nonlocal base_time
    ...
    print(f"Generated {num_recon + num_dropper + num_human} sessions in {output_file}")
